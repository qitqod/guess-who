...
#Set the food's name to be guessed
...
if prompt := st.chat_input():
    ...
    #Send the conversation and random food data to OpenAI
    ...
    if "food" not in st.session_state:
        ...
        st.session_state["messages"].append({
             "role": "assistant", 
             "content": f"Hello. I am thinking of a food. Let's start with this: It's called {food_name}. Try asking yes/no questions to guess it!"
        })
